...
@section('title', 'Edit Itinerary Template')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Itinerary Template</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.itinerary-templates.update', $itineraryTemplate->id) }}" method="POST" enctype="multipart/form-data" id="itinerary-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $itineraryTemplate->name) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="season" name="season" required>
                                                ...
                                                <option value="{{ $key }}" {{ old('season', $itineraryTemplate->season) == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $itineraryTemplate->title) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="subtitle">Subtitle</label>
                                            <input type="text" class="form-control" id="subtitle" name="subtitle" value="{{ old('subtitle', $itineraryTemplate->subtitle) }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="duration_nights" name="duration_nights" value="{{ old('duration_nights', $itineraryTemplate->duration_nights) }}" required min="0">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @if($itineraryTemplate->cover_image)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $itineraryTemplate->cover_image) }}" alt="Cover Image" style="max-width: 200px; max-height: 100px;">
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="4" required>{{ old('description', $itineraryTemplate->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="component-item" data-id="{{ $service->id }}">
                                                    <div class="form-check">
                                                        <input class="form-check-input included-service-checkbox" type="checkbox" name="selected_included_services[]" value="{{ $service->id }}" id="included-{{ $service->id }}"
                                                            {{ in_array($service->id, old('selected_included_services', $itineraryTemplate->selected_included_services ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="component-item" data-id="{{ $service->id }}">
                                                    <div class="form-check">
                                                        <input class="form-check-input excluded-service-checkbox" type="checkbox" name="selected_excluded_services[]" value="{{ $service->id }}" id="excluded-{{ $service->id }}"
                                                            {{ in_array($service->id, old('selected_excluded_services', $itineraryTemplate->selected_excluded_services ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="component-item" data-id="{{ $highlight->id }}">
                                                    <div class="form-check">
                                                        <input class="form-check-input experience-highlight-checkbox" type="checkbox" name="selected_experience_highlights[]" value="{{ $highlight->id }}" id="highlight-{{ $highlight->id }}"
                                                            {{ in_array($highlight->id, old('selected_experience_highlights', $itineraryTemplate->selected_experience_highlights ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="component-item" data-id="{{ $info->id }}">
                                                    <div class="form-check">
                                                        <input class="form-check-input important-information-checkbox" type="checkbox" name="selected_important_information[]" value="{{ $info->id }}" id="info-{{ $info->id }}"
                                                            {{ in_array($info->id, old('selected_important_information', $itineraryTemplate->selected_important_information ?? [])) ? 'checked' : '' }}>
                                                ...
                                                <div class="component-item" data-id="{{ $fact->id }}">
                                                    <div class="form-check">
                                                        <input class="form-check-input quick-fact-checkbox" type="checkbox" name="selected_quick_facts[]" value="{{ $fact->id }}" id="fact-{{ $fact->id }}"
                                                            {{ in_array($fact->id, old('selected_quick_facts', $itineraryTemplate->selected_quick_facts ?? [])) ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="pricing_options[standard_solo]" value="{{ old('pricing_options.standard_solo', $itineraryTemplate->pricing_options['standard_solo'] ?? '') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Standard Package (Couple) *</label>
                                            <input type="number" class="form-control" name="pricing_options[standard_couple]" value="{{ old('pricing_options.standard_couple', $itineraryTemplate->pricing_options['standard_couple'] ?? '') }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="pricing_options[deluxe_solo]" value="{{ old('pricing_options.deluxe_solo', $itineraryTemplate->pricing_options['deluxe_solo'] ?? '') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Deluxe Package (Couple)</label>
                                            <input type="number" class="form-control" name="pricing_options[deluxe_couple]" value="{{ old('pricing_options.deluxe_couple', $itineraryTemplate->pricing_options['deluxe_couple'] ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="payment_terms" name="payment_terms" rows="3">{{ old('payment_terms', $itineraryTemplate->payment_terms) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="cancellation_policy">Cancellation Policy</label>
                                    <textarea class="form-control" id="cancellation_policy" name="cancellation_policy" rows="3">{{ old('cancellation_policy', $itineraryTemplate->cancellation_policy) }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="terms_conditions">Terms & Conditions</label>
                                    <textarea class="form-control" id="terms_conditions" name="terms_conditions" rows="4">{{ old('terms_conditions', $itineraryTemplate->terms_conditions) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Itinerary Template
                            </button>
...
<script>
    ...
    addDay({{ $day->day_number }}, `{{ $day->title }}`, `{{ $day->description }}`, `{{ $day->activities }}`, `{{ $day->meals }}`, `{{ $day->accommodation }}`);
    @endforeach
    ...
    function addDay(dayNumber = null, title = '', description = '', activities = '', meals = '', accommodation = '') {
        ...
        const html = `
            <div class="day-card mb-3 p-3 border rounded">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="days[${currentDayCount}][title]" value="${title}" required>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <button type="button" class="btn btn-danger btn-sm remove-day mt-4" ${currentDayCount === 0 ? 'disabled' : ''}>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="days[${currentDayCount}][description]" rows="3" required>${description}</textarea>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Activities</label>
                            <textarea class="form-control" name="days[${currentDayCount}][activities]" rows="2">${activities}</textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Meals</label>
                            <textarea class="form-control" name="days[${currentDayCount}][meals]" rows="2">${meals}</textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Accommodation</label>
                            <textarea class="form-control" name="days[${currentDayCount}][accommodation]" rows="2">${accommodation}</textarea>
                        </div>
                    </div>
                </div>
            </div>
